(function (vegaEmbed) {
	var spec = {
		...
		data: { name: "data-cffc3c833dbbc5caab66e35e6a702006" },
		mark: { type: "bar" },
		encoding: {
			color: {
				field: "Category",
			...
			tooltip: [
				{ field: "Item Purchased", type: "nominal" },
				{ field: "Count", type: "quantitative" },
				{ field: "Category", type: "nominal" },
			],
			x: {
				field: "Count",
				title: "Count of Purchases",
				type: "quantitative",
			},
			y: {
				field: "Item Purchased",
		...
		params: [
			{
				...
				bind: {
					input: "select",
					options: ["Winter", "Fall", "Summer", "Spring", null],
					labels: ["Winter", "Fall", "Summer", "Spring", "All"],
					name: "Season: ",
				},
			},
		],
		...
		datasets: {
			"data-cffc3c833dbbc5caab66e35e6a702006": [
				{
	...
	const el = document.getElementById("figure4_1");
	vegaEmbed("#figure4_1", spec, embedOpt).catch((error) =>
		showError(el, error)
	);
})(vegaEmbed);
