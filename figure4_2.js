(function (vegaEmbed) {
	var spec = {
		...
		data: { name: "data-0ee76669000c17921d6e9b7bdd32a8f6" },
		mark: { type: "boxplot" },
		encoding: {
			color: {
				field: "Category",
		...
		height: 400,
		title: "Item Purchases by Category",
		transform: [{ calculate: "datum.Count", as: "count" }],
		width: 600,
		$schema: "https://vega.github.io/schema/vega-lite/v5.8.0.json",
		datasets: {
			"data-0ee76669000c17921d6e9b7bdd32a8f6": [
				{
	...
	const el = document.getElementById("figure4_2");
	vegaEmbed("#figure4_2", spec, embedOpt).catch((error) =>
		showError(el, error)
	);
})(vegaEmbed);
